...
BASE_SCRIPT = HERE / "10_candidate_basin_skill_trajectories.py"
spec = importlib.util.spec_from_file_location("skill_candidate", BASE_SCRIPT)
base = importlib.util.module_from_spec(spec)
assert spec.loader is not None
spec.loader.exec_module(base)

STEM = "figure_10b_candidate_basin_skill_trajectories_classic"
LEADS = base.LEADS
...
def load_sources() -> tuple[pd.DataFrame, pd.DataFrame]:
    value_path = SOURCE / "figure_10_candidate_basin_skill_trajectories_basin_values.csv.gz"
    summary_path = SOURCE / "figure_10_candidate_basin_skill_trajectories_summary.csv"
