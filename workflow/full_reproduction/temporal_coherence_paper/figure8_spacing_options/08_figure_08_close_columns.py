#!/usr/bin/env python3
"""Create a close-column review candidate for current manuscript Figure 8.
...
identical to the accepted figure. The manuscript is not modified.

Run from the project root:

    python temporal_coherence_paper/figure8_spacing_options/08_figure_08_close_columns.py
"""
...
def main() -> None:
    ...
    try:
        ...
        figures.save(fig, "figure_08_close_column_spacing_review")
    finally:
        figures.OUTPUT = original_output
        plt.close(fig)

    print(f"Figure 8 review candidate written to {OUTPUT}")
