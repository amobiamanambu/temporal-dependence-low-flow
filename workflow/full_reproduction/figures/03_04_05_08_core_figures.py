#!/usr/bin/env python3
"""Generate the data-forward core figures used in the paper.

Run from the project root, for example:

    python figures/03_04_05_08_core_figures.py --figure all
"""
...
def figure_3_anatomy() -> None:
    ...
    save(fig, "figure_03_trajectory_anatomy")
...
def same_marginal_basin_scores() -> pd.DataFrame:
    ...
    data = pd.read_csv(RECONSTRUCTION_METRICS, usecols=columns, dtype={"GAGE_ID": str})
    data = data[
...
def figure_4_same_marginal_basin_pairs() -> None:
    ...
    save(fig, "figure_04_same_marginal_basin_scores_base")
...
def figure_5_empirical_benchmark_differences() -> None:
    ...
    save(fig, "figure_05_empirical_benchmark_differences")
...
def figure_8_ecoregion_calibration_clouds() -> None:
    ...
    save(fig, "figure_08_ecoregional_calibration_base")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=("3", "4", "5", "8", "all"),
        default="all",
        help="Figure number to generate.",
    )
