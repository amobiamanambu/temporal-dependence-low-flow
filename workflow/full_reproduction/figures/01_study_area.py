#!/usr/bin/env python3
"""Create Figure 1: study area and primary Q10 forecast cohort.
...
Run from the project root:
    ...
    python figures/01_study_area.py --design hydrologic
"""
...
ANALYSIS_SAMPLE = (
    SOURCES / "figure_01_analysis_sample.csv"
)
ECOREGIONS = (
    SOURCES / "figure_01_ecoregions.csv"
)
PRIMARY_METRICS = (
    PAPER_ROOT / "dependence_reconstruction" / "full"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="hydrologic", help="Cartographic design to render (default: hydrologic)",
    )
