#!/usr/bin/env python3
"""Create the typography-review version of the current manuscript Figure 6.

This is the four-gage temporal-validation figure. It reads the archived source
table and writes a separate review PNG, PDF, and SVG without replacing the
figure currently used by the manuscript.
...
FIGURE_DIR = PAPER_ROOT / "figures_v2"
...
STEM = "figure_06_station_typography_review"
...
def configure_style() -> None:
    """Apply the requested one-point increases and bold typography."""
    plt.rcParams.update(
        {
            "font.family": "serif",
            "font.serif": [
...
def draw() -> None:
    ...
    plt.close(fig)
    print(f"Created Figure 6 review files in {OUTPUT}")
