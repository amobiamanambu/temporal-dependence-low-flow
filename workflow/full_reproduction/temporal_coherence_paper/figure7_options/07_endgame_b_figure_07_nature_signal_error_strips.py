#!/usr/bin/env python3
"""Create the accepted current-manuscript Figure 8 temporal validation plot.

This is a presentation-only figure built from the archived basin-first monthly
validation table. The ``07`` filename is retained for provenance because this
graphic was developed before later figures were renumbered. The canonical
Figure 8 entry point is documented in ``accepted_figure_revisions/README.md``.
Running this script does not rebuild or edit the manuscript.

Run from the project root:

    python temporal_coherence_paper/figure7_options/07_endgame_b_figure_07_nature_signal_error_strips.py
"""
...
OPTION_ROOT = PAPER_ROOT / "figure7_options"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Filename stem written inside figure7_options/output.",
    )
