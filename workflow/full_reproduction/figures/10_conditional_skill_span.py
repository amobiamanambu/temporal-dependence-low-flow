#!/usr/bin/env python3
"""Create Figure 10: conditional forecast skill span.

This figure preserves the scientific encoding and ecoregional distribution
Panel a uses a hydrologic GIS basemap; panel b gives the complete distribution
of strict skill-span categories within each ecoregion.

Run from the project root:

    python figures/10_conditional_skill_span.py
"""
...
def save(figure: plt.Figure) -> Path:
    stem = OUTPUT / "figure_10_conditional_skill_span"
