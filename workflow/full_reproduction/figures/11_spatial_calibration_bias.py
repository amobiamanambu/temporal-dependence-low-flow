#!/usr/bin/env python3
"""Create Figure 11: spatial occurrence-calibration bias.
...
Run the final design from the project root:

    python figures/11_spatial_calibration_bias.py --design 5
...
def save(figure, theme: dict) -> None:
    stem = OUTPUT / f"figure_11_spatial_calibration_bias_{theme['name']}"
...
def main() -> None:
    ...
    parser.add_argument(
        "--design", choices=["all", "1", "2", "3", "4", "5"], default="5",
        help="design number to generate; default is the final design (5)",
    )
